...
class FaceOutlineDrawer:
    ...
    OUTLINE_INDICES = [
        # Left Jaw
        93,132,58, 172, 136, 150, 149, 176,211,204,106,
        # Chin
        182,83,18,313,335,
        # Right Jaw
       424,431,400, 378, 379, 365, 397, 288 ,361,323
    ]
...
class CheekContourDrawer:
    ...
    LEFT_CHEEK_INDICES = [323,376, 411, 427, 436,322,164] 
    
    # Right cheek line now starts at landmark 93 (the jaw intersection point).
    RIGHT_CHEEK_INDICES = [93, 147, 187, 207, 216,164]
